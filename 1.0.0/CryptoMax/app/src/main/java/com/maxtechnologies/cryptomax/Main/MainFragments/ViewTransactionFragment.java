...
import com.maxtechnologies.cryptomax.Main.ContactFragments.AddContactFragment2;
...
public class ViewTransactionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String sentStr = Exchange.coinString(transaction.amount, index, true, true);
        ...
        float receivedVal = transaction.amount - transaction.fee;
        received.setText(getResources().getString(R.string.received) + ": " +  Exchange.coinString(receivedVal, index, true, true));

        float price = 0;
        receivedValue.setText(getResources().getString(R.string.value) + ": " +  Exchange.fiatString(price * receivedVal, true, true, true));
