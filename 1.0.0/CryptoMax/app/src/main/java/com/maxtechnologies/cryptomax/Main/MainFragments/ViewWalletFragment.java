...
import com.maxtechnologies.cryptomax.Main.SendFragments.SendFragment1;
import com.maxtechnologies.cryptomax.Main.WalletFragments.WalletSettingsFragment;
...
public class ViewWalletFragment extends Fragment implements NetworkCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            qrCodeImage = OtherTools.encodeAsBitmap(CryptoMaxApi.getWallet(walletIndex).address, displayMetrics.widthPixels);
        }
    ...
    private class CustomPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position) {
                case 0:
                    return WalletTransactionsFragment.newInstance(walletIndex);

                case 1:
                    return WalletSettingsFragment.newInstance(walletIndex);
