        ...
        agreeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    qrCodeImage = MiscUtils.encodeAsBitmap(privateKey, displayMetrics.widthPixels);
                }
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ((DrawerActivity) getActivity()).subWalletTickers();
                        ((DrawerActivity) getActivity()).setAssets();
