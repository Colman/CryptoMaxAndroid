...
public class Settings {
    ...
    public static boolean transactionsChecked;
    ...
    public static void loadSettings(Context context) {
        try {
            ...
            Settings.transactionsChecked = jObj.getBoolean("TRANSACTIONSCHECKED");
        }
            ...
            Settings.transactionsChecked = false;
        }
    }
    ...
    public static void saveSettings(Context context) {
        ...
        try {
            ...
            jObj.put("TRANSACTIONSCHECKED", Settings.transactionsChecked);
