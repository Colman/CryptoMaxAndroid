...
public class ChartSettingsFragment extends Fragment {
    ...
    private CheckBox transactionsCheckbox;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        transactionsCheckbox = (CheckBox) rootView.findViewById(R.id.transactions);
    ...
    public void saveSettings() {
        ...
        Settings.transactionsChecked = transactionsCheckbox.isChecked();
    ...
    private void setSettingsUI() {
        ...
        if(Settings.transactionsChecked) {
            transactionsCheckbox.setChecked(true);
        }
    }
}
