...
import com.maxtechnologies.cryptomax.wallets.ripple.TransactionListener;
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!sent) {
                    ...
                    wallet.send(parent.toAddress, parent.amount, parent.fee, parent.password, new TransactionListener() {
                        @Override
