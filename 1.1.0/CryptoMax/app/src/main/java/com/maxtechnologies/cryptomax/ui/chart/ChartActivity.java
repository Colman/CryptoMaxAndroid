...
import com.maxtechnologies.cryptomax.ui.UpActivity;
...
public class ChartActivity extends ExchangeListenerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Asset coin = StaticVariables.exchanges[Settings.exchangeIndex].coins.get(index);
