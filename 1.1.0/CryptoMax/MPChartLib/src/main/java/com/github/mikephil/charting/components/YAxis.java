...
public class YAxis extends AxisBase {
    ...
    /**
     * y-value of the extra point to draw as a y-axis label
     */
    protected float mExtraYValue = 0f;
    ...
    /**
     * Returns the extra y-value to draw as a label
     *
     * @return
     */
    public float getExtraYValue() {
        return mExtraYValue;
    }

    /**
     * Sets the extra y-value to draw as a label
     *
     * @param yExtraValue
     */
    public void setExtraYValue(float yExtraValue) {
        mExtraYValue = yExtraValue;
    }
