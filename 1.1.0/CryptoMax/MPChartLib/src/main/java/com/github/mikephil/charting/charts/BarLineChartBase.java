...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    public boolean stopScrolling = false;
    /**
    ...
    /**
     * Array of entries to be statically highlighted
     */
    protected StaticHighlight[] mStaticHighlights;

    /**
     * Array of bitmaps for the static markers
     */
    protected Bitmap[] mStaticBitmaps;

    /**
     * View used for static markers
     */
    protected StaticMarkerView mStaticMarker;

    /**
     * Should static markers be drawn?
     */
    protected boolean mDrawStaticMarkers = true;

    /**
     * Width of the static markers. (In chart units)
     */
    protected float mStaticMarkerWidth = 5f;

    /**
     * Width of the static marker line. (In chart units)
     */
    protected float mStaticMarkerLineWidth = 0.1f;

    /**
     * Color of the static marker line
     */
    protected int mStaticMarkerLineColor = Color.WHITE;

    /**
     * Radius of the static marker circle. (In chart units)
     */
    protected float mStaticMarkerCircleRadius = 0.75f;
    ...
    /**
     * Statically highlight these entries
     * @param highlights
     */
    public void staticallyHighlightValues(StaticHighlight[] highlights) {

        // set the indices to highlight
        mStaticHighlights = highlights;
        mStaticBitmaps = new Bitmap[highlights.length];
    ...
    /**
     * Get the view for the static highlights
     */
    public StaticMarkerView getStaticMarkerView() {
        return mStaticMarker;
    }

    /**
     * Set the view for the static highlights
     * @param view
     */
    public void setStaticMarker(StaticMarkerView view) {
        mStaticMarker = view;
    }
     ...
     * @return
     */
    public boolean getDrawStaticMarkers() {return mDrawStaticMarkers;}

    /**
     * Set whether static markers should be drawn
     *
     * @return
     */
    public void setDrawStaticMarkers(boolean draw) {mDrawStaticMarkers = draw;}

    /**
     * Returns the desired width of the static marker. (In chart units)
     *
     * @return
     */
    public float getStaticMarkerWidth() {return mStaticMarkerWidth;}

    /**
     * Sets the desired width of the static marker. (In chart units)
     *
     * @return
     */
    public void setStaticMarkerWidth(float width) {mStaticMarkerWidth = width;}

    /**
     * Returns the desired width of the static marker line. (In chart units)
     *
     * @return
     */
    public float getStaticMarkerLineWidth() {return mStaticMarkerLineWidth;}

    /**
     * Sets the desired width of the static marker line. (In chart units)
     *
     * @return
     */
    public void setStaticMarkerLineWidth(float width) {mStaticMarkerLineWidth = width;}

    /**
     * Returns the desired color of the static marker line.
     *
     * @return
     */
    public int getStaticMarkerLineColor() {return mStaticMarkerLineColor;}

    /**
     * Sets the color of the static marker line.
     *
     * @return
     */
    public void setStaticMarkerLineColor(int color) {mStaticMarkerLineColor = color;}

    /**
     * Returns the desired radius of the static marker circle. (In chart units)
     *
     * @return
     */
    public float getStaticMarkerCircleRadius() {return mStaticMarkerCircleRadius;}

    /**
     * Sets the desired radius of the static marker circle. (In chart units)
     *
     * @return
     */
    public void setStaticMarkerCircleRadius(float radius) {mStaticMarkerCircleRadius = radius;}
